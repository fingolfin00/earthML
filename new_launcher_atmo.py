...
from earthml.manager import build_loss
...
if __name__ == "__main__":
    ...
    loss_sweep = [
        ...
        {"loss_sel": "HeteroBiasCorrectionLoss", "use_first_input": True, "variance_type": "spatial", "latitudes": False},
