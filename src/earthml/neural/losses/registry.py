...
_LOSSES: dict[str, str] = {
    ...
    "GeoMaskedMSEMultiScaleLoss": "earthml.neural.losses.mse:GeoMaskedMSEMultiScaleLoss",
    "SpatialCVaRMSELoss"        : "earthml.neural.losses.mse:SpatialCVaRMSELoss",
    "SpatialDegradationMSELoss" : "earthml.neural.losses.mse:SpatialDegradationMSELoss",
