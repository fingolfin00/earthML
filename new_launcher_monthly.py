...
if __name__ == "__main__":
    ...
    vars_sweep                  = ["sst"]             # e.g. ["sst", "ssh", "sss", "t14d", "t17d"]
    regions_sweep               = ["natlantic"]                               # e.g. ["pacific", "natlantic", "indian"]
    ...
    # Set var categories
    vars_cloud_oras5        = ("sst", "ssh") # only for juno experiments
